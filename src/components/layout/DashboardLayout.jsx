...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Atlet Terbaik',    path: '/dashboard/analisapingat', icon: 'medal',    roles: ['superadmin', 'admin', 'pengurus_teknik'] },
  ...
  {
    section: 'AKSES PANTAS HOME',
    items: [
      { label: 'Setup Galeri Gambar',      path: '/dashboard/galeri-setup',                icon: 'image',  roles: ['superadmin', 'admin'] },
      { label: 'Setup Buku Kejohanan',     path: '/dashboard/buku-kejohanan-link-setup',   icon: 'book',   roles: ['superadmin', 'admin'] },
      { label: 'Setup Buku Program',       path: '/dashboard/buku-program-setup',          icon: 'file',   roles: ['superadmin', 'admin'] },
    ],
  },
  {
    section: 'SISTEM',
    items: [
      ...
      { label: 'Backup Sistem',       path: '/dashboard/backup',   icon: 'backup',   roles: ['superadmin'] },
...
const Icons = {
  ...
  sijil: <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" /></svg>,
  download: <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>,
}
...
export default function DashboardLayout({ children }) {
  ...
  // Default = false (sembunyi) sehingga sah document wujud + aktif=true.
  // Ini elak menu nampak sebelum snapshot pertama fire, dan elak menu nampak
  // bila document belum dicipta langsung.
  ...
  useEffect(() => {
    ...
    const unsub1 = onSnapshot(
      ...
      snap => {
        ...
        // Backward-compat: field tak wujud = anggap aktif (sistem lama)
