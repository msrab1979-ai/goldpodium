...
const LANGKAH = {
  setup: [
    {
      ...
      cara: ['Klik butang "+ Tambah Kejohanan"', 'Isi nama, tarikh dan peringkat (sekolah/daerah/negeri)', 'Pilih Bilangan Lorong trek (4–8) ikut padang anda — acara baru akan ikut nilai ini', 'Klik Simpan'],
      visual: 'borang',
    ...
    },
    {
      ...
      cara: ['Klik "+ Tambah Acara"', 'Pilih jantina, kategori dan jenis peringkat (Saringan / Terus Final)', 'Bilangan lorong auto ikut tetapan kejohanan (4–8) — boleh ubah per acara jika perlu'],
      visual: 'senarai',
      kejPath: 'acara',
  ...
  tetapan: [
    ...
    {
      no: '20',
      tajuk: 'Tetapan Lorong (Trek 4–8 Lorong)',
      penerangan: 'Sistem sokong trek 4 hingga 8 lorong. Susunan lorong final dibuat automatik.',
      lokasi: 'Utama → Kejohanan (Bilangan Lorong) & Tetapan (kumpulan lorong)',
      cara: ['Set Bilangan Lorong (4–8) masa bina kejohanan — acara baru ikut nilai ini', 'Trek 8 lorong: susunan final ikut piawai penuh World Athletics (undian kumpulan)', 'Trek 4–7 lorong: sistem guna susunan automatik — ranking terbaik dapat lorong tengah', 'Jika finalis lebih dari bilangan lorong, sistem beri amaran masa jana final'],
      visual: 'toggle',
      adminPath: '/admin/tetapan',
      label: 'Pergi ke Tetapan',
    },
