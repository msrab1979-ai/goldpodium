    ...
    try {
      ...
      const joined = jadualSnap.docs.map(d => {
        ...
        return {
          ...
          hadAtletPerSekolah: acara.hadAtletPerSekolah ?? null,
                      ...
                      <table className="w-full text-xs">
                        <thead>
                          <tr className="border-b border-gray-100 bg-gray-50/70 text-[9px] font-bold text-gray-400 uppercase tracking-wide">
                            ...
                            <th className="px-3 py-2 text-center w-28">Had / Jenis</th>
                                ...
                                <td className="px-3 py-2.5 text-center">
                                  {r.isIndividu === undefined ? (
                                    ...
                                    <div className="flex flex-col items-center gap-0.5">
                                      ...
                                      {r.hadAtletPerSekolah != null && (
                                        <span className="text-[9px] font-black text-gray-600">
                                          maks <span className="text-[#003399]">{r.hadAtletPerSekolah}</span>/sekolah
                                        </span>
                                      )}
                                    </div>
                                  )}
