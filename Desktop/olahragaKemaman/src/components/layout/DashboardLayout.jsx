...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Setup Acara',       path: '/dashboard/acara',       icon: 'list',      roles: ['superadmin', 'admin'] },
      { label: 'Jadual Acara',      path: '/dashboard/jadual',      icon: 'calendar',  roles: ['superadmin', 'admin'] },
  ...
  },
  {
    ...
    items: [
      ...
      // Keputusan Rasmi — superadmin/teknik sahkan, pengurus pasukan hantar bantahan
      { label: 'Keputusan Rasmi',  path: '/dashboard/rasmi',       icon: 'checkCircle', roles: ['superadmin', 'pengurus_teknik', 'admin'] },
